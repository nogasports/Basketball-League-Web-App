...
import { ChevronRight, Trophy, Users, Star, Calendar, Clock, MapPin, ArrowRight, Mail } from "lucide-react";
export const HomePage = () => {
  ...
  return <>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex space-x-4">
                <button className="bg-[#FBDA67] px-8 py-4 rounded-[2px] hover:bg-[#f0cc4d] flex items-center shadow-md hover:shadow-lg transition-all text-black">
      ...
      {/* ... (Previous sections remain the same but with updated colors) ... */}
    </>;
};